...
namespace advent_of_code_tests
{
    public class Day01UnitTests
    {
        ...
        public void IncreasedDepthsSuccess()
        {
            ...
            int ans1 = advent_of_code.Day01.IncreasedDepths(input1);
            Assert.Equal(7, ans1);

            int[] input2 = { 139, 351, 276, 60, 196, 381, 169, 448, 173, 43, 208, 69, 288, 304, 416, 197, 471, 398, 326, 154 };
            int ans2 = advent_of_code.Day01.IncreasedDepths(input2);
            Assert.Equal(9, ans2);
        }
        ...
        public void IncreasedDepthsFail()
        {
            ...
            int ans = advent_of_code.Day01.IncreasedDepths(input);
